...
# 
# 
# def test_block_modelValues1(solver):
#   solver.setOption("produce-models", "true")
#   solver.setOption("block-models", "literals")
#   x = solver.mkConst(solver.getBooleanSort(), "x")
#   solver.assertFormula(x.eqTerm(x))
...
# 
# 
# def test_block_modelValues2(solver):
#   solver.setOption("produce-models", "true")
#   x = solver.mkConst(solver.getBooleanSort(), "x")
#   solver.assertFormula(x.eqTerm(x))
#   solver.checkSat()
...
# 
# 
# def test_block_modelValues3(solver):
#   solver.setOption("block-models", "literals")
#   x = solver.mkConst(solver.getBooleanSort(), "x")
#   solver.assertFormula(x.eqTerm(x))
#   solver.checkSat()
...
# 
# 
# def test_block_modelValues4(solver):
#   solver.setOption("produce-models", "true")
#   solver.setOption("block-models", "literals")
#   x = solver.mkConst(solver.getBooleanSort(), "x")
#   solver.assertFormula(x.eqTerm(x))
...
# 
# 
# def test_block_modelValues5(solver):
#   solver.setOption("produce-models", "true")
#   solver.setOption("block-models", "literals")
#   x = solver.mkConst(solver.getBooleanSort(), "x")
#   solver.assertFormula(x.eqTerm(x))
...
# 
# 
# def test_define_funGlobal(solver):
...
# 
# 
# def test_define_funRecGlobal(solver):
#   bSort = solver.getBooleanSort()
#   fSort = solver.mkFunctionSort(bSort, bSort)
# 
#   solver.push()
...
# 
# 
# def test_define_funsRec(solver):
#   uSort = solver.mkUninterpretedSort("u")
#   bvSort = solver.mkBitVectorSort(32)
#   funSort1 = solver.mkFunctionSort(bvSort, bvSort, bvSort)
#   funSort2 = solver.mkFunctionSort(uSort, solver.getIntegerSort())
...
# 
# 
# def test_defineFunsRecGlobal(solver):
#   bSort = solver.getBooleanSort()
#   fSort = solver.mkFunctionSort(bSort, bSort)
# 
#   solver.push()
...
# 
# 
# def test_defineFunsRecWrongLogic(solver):
#   solver.setLogic("QF_BV")
#   uSort = solver.mkUninterpretedSort("u")
#   bvSort = solver.mkBitVectorSort(32)
#   funSort1 = solver.mkFunctionSort(bvSort, bvSort, bvSort)
...
# 
# 
# def test_getInterpolant(solver):
#   solver.setLogic("QF_LIA")
...
# 
# 
# def test_getQuantifierElimination(solver):
#   x = solver.mkVar(solver.getBooleanSort(), "x")
#   forall =      solver.mkTerm(FORALL,
#                       solver.mkTerm(BOUND_VAR_LIST, x),
...
# 
# 
# def test_getQuantifierEliminationDisjunct(solver):
#   x = solver.mkVar(solver.getBooleanSort(), "x")
#   forall =      solver.mkTerm(FORALL,
#                       solver.mkTerm(BOUND_VAR_LIST, x),
#                       solver.mkTerm(OR, x, solver.mkTerm(NOT, x)))
...
# 
# 
# def test_getSynthSolutions(solver):
#   solver.setOption("lang", "sygus2")
#   solver.setOption("incremental", "false")
# 
#   nullTerm
...
#   
# 
#     assert  "((_ tuple_project 0 3 2 0 1 2) (mkTuple true 3 \"C\" (singleton " \
#       "\"Z\")))" ==      str(projection)
# 
